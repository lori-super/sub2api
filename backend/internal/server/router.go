...
func registerRoutes(
	...
	routes.RegisterModelPlazaRoutes(v1, h, jwtAuth, settingService, panelRateLimiter)
	routes.RegisterModelPriceRoutes(v1, h, optionalJWTAuth, settingService, panelRateLimiter)

...
func provideCleanup(
	...
	upstreamPriceMonitorRunner *service.UpstreamPriceMonitorRunner,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"UpstreamPriceMonitorRunner", func() error {
				if upstreamPriceMonitorRunner != nil {
					upstreamPriceMonitorRunner.Stop()
				}
				return nil
			}},

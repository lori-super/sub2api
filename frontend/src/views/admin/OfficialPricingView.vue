...
function buildModelPayload(
  ...
  return {
    ...
    input_multiplier_override: model.input_multiplier_override,
    output_multiplier_override: model.output_multiplier_override,
    cache_write_multiplier_override: model.cache_write_multiplier_override,
    cache_read_multiplier_override: model.cache_read_multiplier_override,
    display_input_per_million_override: model.display_input_per_million_override,
    display_output_per_million_override: model.display_output_per_million_override,
    display_cache_write_per_million_override: model.display_cache_write_per_million_override,
    display_cache_read_per_million_override: model.display_cache_read_per_million_override,
